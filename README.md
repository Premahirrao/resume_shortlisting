...
1. Extract text from PDFs/images (Tesseract) ✨
2. Detect and translate to English (free API) ✨
3. Generate AI embeddings
4. Rank candidates by relevance
5. Fetch social stats (GitHub, LeetCode, CodeChef)
...
2. Review documentation files (QUICK_START.md, SETUP_GUIDE.md)
3. Check backend logs: http://127.0.0.1:8000/docs
